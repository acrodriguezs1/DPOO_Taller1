...
public class PanelOpciones extends JPanel implements ActionListener{
	//dialogo top10 
	private DialogoTop10 DialogoTop10;
	//opcion nuevo 
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (comando.equals(NUEVO)) {
			//mandar a crear tablero nuevo con la info que se tiene
		}
		else if(comando.equals(TOP10)) {
			DialogoTop10 dialogover = new DialogoTop10(ventana);
		...
		{
			DialogoFinal dialogo = new DialogoFinal(ventana);
