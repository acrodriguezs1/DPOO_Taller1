...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais al cual pertenece un atleta");
		System.out.println("14. Salir de la apliicacion\n");
	}
	/**
	 * Le muestra al usuario el pais del cual el atleta es originario (tarea)
	 */
	private void ejecutarPaisdelatleta()
	{
		String persona = input("Por favor ingrese el nombre del atleta");
		String nacion = calculadora.paisDelAtleta(persona);
		System.out.println("El atleta " + persona + " es de: " + nacion);
	}
