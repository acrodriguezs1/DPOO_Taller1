...
public class CalculadoraEstadisticas
{
	...
	public String paisDelAtleta(String atleta)
	{
		Atleta unAtleta = buscarAtleta(atleta);
		Pais rta= unAtleta.darPais();
		String respuesta = rta.darNombre();
		return respuesta;
	}
	/**
	...
	/**
	 * Retorna el pais al cual pertenece un atleta
	 */
